...
class Board(BaseAPI, board_pb2_grpc.BoardServicer):
    ...
    def set_categories(self, request, context):
        ...
        with self.locator.get_service(BoardService, metadata) as board_service:
            return self.locator.get_info(
                BoardInfo, board_service.set_categories(params)
            )
    ...
    def list(self, request, context):
        ...
        with self.locator.get_service(BoardService, metadata) as board_service:
            ...
            return self.locator.get_info(
                BoardsInfo, board_vos, total_count, minimal=self.get_minimal(params)
            )
    ...
    def stat(self, request, context):
        ...
        with self.locator.get_service(BoardService, metadata) as board_service:
            return self.locator.get_info(StatisticsInfo, board_service.stat(params))
