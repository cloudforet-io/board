...
class TestPostService(unittest.TestCase):
    ...
    def test_create_post(
        self, mock_check_exist_file, mock_update_file_reference, mock_get_file, *args
    ):
        ...
        params = {
            ...
            "options": {"is_pinned": True, "is_popup": False},
            "writer": "Kwon",
    ...
    @patch.object(FileManager, "update_file_reference")
    @patch.object(FileManager, "check_exist_file")
    def test_create_post_none_category(
        self, mock_check_exist_file, mock_update_file_reference, mock_get_file, *args
    ):
        board_vo = BoardFactory()
    ...
    @patch.object(FileManager, "update_file_reference")
    @patch.object(FileManager, "check_exist_file")
    def test_create_post_with_options_one_key(
        self, mock_check_exist_file, mock_update_file_reference, mock_get_file, *args
    ):
        board_vo = BoardFactory()
        mock_get_file.return_value = {
        ...
        params = {
            ...
            "title": "test sample",
            "contents": "This is test sample of contents.",
            "options": {"is_pinned": True, "is_popup": True},
            "writer": "Kwon",
            "files": [mock_get_file.return_value.get("file_id")],
            "user_domain_id": self.transaction.get_meta("domain_id"),
            "domain_id": self.domain_id,
    ...
    def test_create_post_invalid_options(self):
        ...
        params = {
            ...
            "title": "test sample",
            "contents": "This is test sample of contents.",
            "options": {"is_pinned": True, "is_popup": False, "is_check": True},
            "writer": "Kwon",
            "user_domain_id": self.transaction.get_meta("domain_id"),
            "domain_id": self.domain_id,
            "user_id": utils.generate_id("user"),
    ...
    @patch.object(FileManager, "update_file_reference")
    @patch.object(FileManager, "check_exist_file")
    def test_create_post_valid_categories(
        self, mock_check_exist_file, mock_update_file_reference, mock_get_file, *args
    ):
        board_vo = BoardFactory()
    ...
    def test_update_post(self):
        board_vo = BoardFactory()
        post_vo = PostFactory(board_id=board_vo.board_id, domain_id=self.domain_id)
    ...
    def test_update_post_options_invalid_options(self):
        board_vo = BoardFactory()
        options = {"is_pinned": False, "is_popup": True}
        post_vo = PostFactory(
            board_id=board_vo.board_id, options=options, domain_id=self.domain_id
        )
        print(post_vo.options)
        params = {
            "board_id": post_vo.board_id,
